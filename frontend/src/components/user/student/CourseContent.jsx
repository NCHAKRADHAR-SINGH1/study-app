...
const CourseContent = () => {
   ...
   const playVideo = (videoPath, index) => {
      ...
      setVideoError(""); // Reset error when new video is played
   };
                     ...
                     return (
                        <Accordion.Item key={index} eventKey={index.toString()}>
                           ...
                           <Accordion.Body>
                              ...
                              {section.S_content && (
                                 <>
                                    <Button color='success' className='mx-2' variant="text" size="small" onClick={() => playVideo(`${apiBaseUrl}${section.S_content.path}`, index)}>
                                       Play Video
                                    </Button>
            ...
            <div className="course-video w-50">
               {currentVideo && !videoError && (
                  <ReactPlayer
                     ...
                     height='100%'
                     controls
                     onError={() => setVideoError("Video failed to load. Please check the file or try again.")}
                  />
               )}
               {videoError && (
